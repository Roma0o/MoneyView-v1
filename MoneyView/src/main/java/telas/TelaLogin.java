...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        try {
            ...
            String resultado = usuarioDAO.login(email, senha);
            
            if (resultado.startsWith("Login bem-sucedido")) {
                ...
                JOptionPane.showMessageDialog(this, resultado, "erro", JOptionPane.INFORMATION_MESSAGE);
            }
